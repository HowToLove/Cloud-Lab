 ...
 * 
 */
function stu_handin_a_question_of_homework($classid,$charpter,$lesson,$questionid,$studentid,$answer='')
{
	return handin_question(getHomeworkId($classid,$charpter,$lesson),$questionid,$studentid,$answer);
}
/**
